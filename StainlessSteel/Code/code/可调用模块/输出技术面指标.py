...
obv = dis.getOBV(excel_path, 4, 5, 14, '20140102')
kdj = dis.getKDJ(excel_path, 4, 14, '20140102', 3, 3)
rsi = dis.getRSI(excel_path, 4, 14, '20140102')
wr = dis.getWR(excel_path, 4, 14, '20140102')
psy = dis.getPSY(excel_path, 4, 14, '20140102')
...
future_path = '../文件/日期格式规范化期货价格.xls'
