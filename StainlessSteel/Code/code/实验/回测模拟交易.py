...
def initialize(context):
    ...
    context.K1 = 0.5  # 如果这个值大的话说明空头容易被触发
    context.K2 = 0.3  # 如果这个值大的话多头容易触发
    # 止损线
    context.portfolio_stop_loss = 0.95  # 止损线
    # 止盈线
    context.portfolio_stop_win = 1.05  # 止盈线
    # 是否已经触发止损
    context.stop_loss_triggered = False  # 是否已经出发止损
    # 是否已经触发止盈
    context.stop_win_triggered = False  # 是否已经出发止盈
